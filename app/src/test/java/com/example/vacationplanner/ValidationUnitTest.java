...
public class ValidationUnitTest {
    ...
    public void correctUsername_Validation() {
        assertTrue(ValidationUtil.validateUsername("Tester1"));
    }
    ...
    public void incorrectUsername_Validation(){
        assertFalse(ValidationUtil.validateUsername("test1"));
    }
    ...
    public void correctPassword_Validation(){
        assertTrue(ValidationUtil.validatePassword("Tester1!"));
    }
    ...
    public void incorrectPassword_Validation(){
        assertFalse(ValidationUtil.validatePassword("test1"));
    }
}